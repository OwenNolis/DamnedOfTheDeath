...
namespace DamnedOfTheDeath.UI
{
    public class GameOverScreen
    {
        ...
        public GameOverScreen(SpriteFont font, SpriteFont titleFont, Texture2D buttonTexture, GraphicsDevice graphicsDevice, Texture2D backgroundTexture)
        {
            _font = font;
            ...
            // Position "Game Over" in the center of the screen
            _gameOverPosition = new Vector2(screenWidth / 2 - font.MeasureString("Game Over").X / 2, screenHeight / 2 - 100);
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.DrawString(_titleFont, "Game Over", _gameOverPosition, Color.Black);
